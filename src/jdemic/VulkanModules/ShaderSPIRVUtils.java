...
public class ShaderSPIRVUtils
{
    ...
    {
        return compileShaderAbsoluteFile(Objects.requireNonNull(
                                             Thread.currentThread().getContextClassLoader().getResource(shaderFile)).toExternalForm(), shaderKind);
    }
