...
public class GameLogicTest {
    ...
    public void testDriveFerryGameStateOverloadReturnsFalse() {
        // Passing a fresh GameState with no players — playerState arg is null, should not move / return false
        assertFalse(new DriveFerryAction(chicago).isValid(new GameState(), null));
    }
    ...
    public void testDirectFlightGameStateOverloadReturnsFalse() {
        Card chicagoCard = new Card("Chicago", CardType.CITY, chicago);
        assertFalse(new DirectFlightAction(chicago, chicagoCard).isValid(new GameState(), null));
    }
    ...
    public void testCharterFlightGameStateOverloadReturnsFalse() {
        Card atlantaCard = new Card("Atlanta", CardType.CITY, atlanta);
        assertFalse(new CharterFlightAction(london, atlantaCard).isValid(new GameState(), null));
    }
    ...
    public void testShuttleFlightGameStateOverloadReturnsFalse() {
        assertFalse(new ShuttleFlightAction(chicago).isValid(new GameState(), null));
    }
